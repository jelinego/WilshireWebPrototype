...
class BusinesSoul_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="businessoul-chosen-select" <?php $this->link(); ?>>
                    <?php
...
Class BusinesSoul_Customize_Horizontal_Line extends WP_Customize_Control {
    public $type = 'hr';
...
class BusinesSoul_Multi_Input_Custom_Control extends WP_Customize_Control {
    /**
     * Control type
     *
     * @var string
...
class BusinesSoul_Note_Control extends WP_Customize_Control {
