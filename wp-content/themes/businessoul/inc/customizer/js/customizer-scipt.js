...
( function( $, api ) {
    ...
    api.controlConstructor['businessoul-repeater-text'] = api.Control.extend({
        ...
        // upsell 
    api.sectionConstructor['businessoul-upsell'] = api.Section.extend( {
...
*/
 jQuery(document).ready(function($) {
    // $('#businessoul-img-container li label img').click(function(){       
    //     $('#businessoul-img-container li').each(function(){
    //         $(this).find('img').removeClass ('businessoul-radio-img-selected') ;
    //     });
    //     $(this).addClass ('businessoul-radio-img-selected') ;
    // }); 
    ...
    $( document ).on( 'click', '.customize_multi_add_field', businessoul_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', businessoul_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', businessoul_customize_multi_remove_field )
    ...
    $('#customize-control-theme_options-layout_options_blog #businessoul-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_blog #businessoul-img-container li').each(function(){
            $(this).find('img').removeClass ('businessoul-radio-img-selected') ;
        });
        $(this).addClass ('businessoul-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #businessoul-img-container li label img').click(function(){       
        $('#customize-control-theme_options-layout_options_archive #businessoul-img-container li').each(function(){
            $(this).find('img').removeClass ('businessoul-radio-img-selected') ;
        });
        $(this).addClass ('businessoul-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #businessoul-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_page #businessoul-img-container li').each(function(){
            $(this).find('img').removeClass ('businessoul-radio-img-selected') ;
        });
        $(this).addClass ('businessoul-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #businessoul-img-container li label img').click(function(){        
        $('#customize-control-theme_options-layout_options_single #businessoul-img-container li').each(function(){
            $(this).find('img').removeClass ('businessoul-radio-img-selected') ;
        });
        $(this).addClass ('businessoul-radio-img-selected') ;
    });    

    function businessoul_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            businessoul_customize_multi_write( $control );
    }

    function businessoul_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        businessoul_customize_multi_write( $control );
    }

    function businessoul_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function businessoul_customize_multi_write( $element) {
